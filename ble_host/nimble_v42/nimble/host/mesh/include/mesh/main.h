...
struct bt_mesh_provisioner {
     ...
     *  @return Zero on success or negative error code otherwise
     */
    int  (*prov_input_num)(bt_mesh_output_action_t act, u8_t size, u8_t link_idx);
     ...
     *  @return Zero on success or negative error code otherwise
     */
     int  (*prov_output_num)(bt_mesh_input_action_t act, void *data, u8_t size, u8_t link_idx);
