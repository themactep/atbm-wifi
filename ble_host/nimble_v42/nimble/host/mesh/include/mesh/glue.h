...
#define CODE_UNREACHABLE BT_ERR("CODE_UNREACHABLE\n"); assert(false)
...
#define MESH_BIT_MASK(n) (BIT(n) - 1)
...
#define CONFIG_BT_MESH_PROV_NODES_MAX		MYNEWT_VAL(BLE_MESH_PROV_NODES_MAX)
#define CONFIG_BT_MESH_UNPROV_ADD_MAX		MYNEWT_VAL(BLE_MESH_UNPROV_ADD_MAX)
...
static inline void k_sem_free(struct k_sem *sem)
{
	ble_npl_sem_free(sem);
}
