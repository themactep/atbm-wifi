...
#define BLE_ADV_INSTANCES    ((MYNEWT_VAL_BLE_MULTI_ADV_INSTANCES) + 1)
...
#define BLE_MBUF_HDR_F_CONN_CREDIT      (0x00020000)
#define BLE_MBUF_HDR_F_IGNORED          (0x00010000)
#define BLE_MBUF_HDR_F_SCAN_REQ_TXD     (0x00008000)
#define BLE_MBUF_HDR_F_INITA_RESOLVED   (0x00004000)
#define BLE_MBUF_HDR_F_EXT_ADV_SEC      (0x00002000)
#define BLE_MBUF_HDR_F_EXT_ADV          (0x00001000)
#define BLE_MBUF_HDR_F_RESOLVED         (0x00000800)
#define BLE_MBUF_HDR_F_AUX_PTR_WAIT     (0x00000400)
#define BLE_MBUF_HDR_F_AUX_INVALID      (0x00000200)
#define BLE_MBUF_HDR_F_CRC_OK           (0x00000100)
#define BLE_MBUF_HDR_F_DEVMATCH         (0x00000080)
#define BLE_MBUF_HDR_F_MIC_FAILURE      (0x00000040)
#define BLE_MBUF_HDR_F_SCAN_RSP_TXD     (0x00000020)
#define BLE_MBUF_HDR_F_SCAN_RSP_CHK     (0x00000010)
#define BLE_MBUF_HDR_F_RXSTATE_MASK     (0x0000000F)
...
struct ble_mbuf_hdr
{
    ...
    uint32_t beg_cputime;/*rx start time(set in ble_phy_rx_start_isr), RTC*/
