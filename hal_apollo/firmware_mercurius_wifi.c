...
#if (defined CONFIG_SUPPORT_MERCURIUS_FIRMWARE_H_ || defined CONFIG_SUPPORT_WIFI4_ALL_FIRMWARE_H_)
...
#ifdef USB_BUS
#include "firmware_mercurius_usb.h"
#endif
#ifdef SDIO_BUS
#include "firmware_mercurius_sdio.h"
#endif
#ifdef SPI_BUS
#include "firmware_mercurius_spi.h"
#endif
...
#else // (defined CONFIG_SUPPORT_MERCURIUS_FIRMWARE_H_ || defined CONFIG_SUPPORT_WIFI4_ALL_FIRMWARE_H_)
int load_usb_wifi_Mercurius_firmware(struct firmware_altobeam *fw_altobeam)
{
	return -1;
}
#endif //(defined CONFIG_SUPPORT_MERCURIUS_FIRMWARE_H_ || defined CONFIG_SUPPORT_WIFI4_ALL_FIRMWARE_H_)
